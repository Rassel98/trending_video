    ...
    return Scaffold(
      ...
      child: Obx(
        () => controller.isLoading.value
            ...
            : RefreshIndicator(
                onRefresh: () async => controller.getAllVideos(),
                child: Padding(
                        ...
                        controller: controller.scrollController,
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              ...
                              // onTap: () => Get.to(() =>  Player( videoUrl: model.manifest.toString()),transition: Transition.leftToRight),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Stack(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(onPressed: () => print, icon: const Icon(Icons.more_vert_sharp))
                                    ],
                                  ),
                                  Padding(
